-- =============================================================================
-- VERIFY AND CREATE TRANSFER FUNCTIONS
-- =============================================================================
-- This script checks if the transfer functions exist and creates them if missing
-- Run this in your Supabase SQL Editor to ensure transfer functions are available
...
DO $$
BEGIN
    RAISE NOTICE '=== CHECKING EXISTING TRANSFER FUNCTIONS ===';
    
    -- Check transfer_stock function
    IF EXISTS (
        SELECT 1 FROM information_schema.routines 
        WHERE routine_name = 'transfer_stock' 
        AND routine_schema = 'public'
    ) THEN
        RAISE NOTICE '✅ transfer_stock function EXISTS';
    ELSE
        RAISE NOTICE '❌ transfer_stock function MISSING';
    END IF;
    
    -- Check transfer_stock_to_truck function
    IF EXISTS (
        SELECT 1 FROM information_schema.routines 
        WHERE routine_name = 'transfer_stock_to_truck' 
        AND routine_schema = 'public'
    ) THEN
        RAISE NOTICE '✅ transfer_stock_to_truck function EXISTS';
    ELSE
        RAISE NOTICE '❌ transfer_stock_to_truck function MISSING';
    END IF;
    
    -- Check transfer_stock_from_truck function
    IF EXISTS (
        SELECT 1 FROM information_schema.routines 
        WHERE routine_name = 'transfer_stock_from_truck' 
        AND routine_schema = 'public'
    ) THEN
        RAISE NOTICE '✅ transfer_stock_from_truck function EXISTS';
    ELSE
        RAISE NOTICE '❌ transfer_stock_from_truck function MISSING';
    END IF;
    
    -- Check validate_transfer_request function
    IF EXISTS (
        SELECT 1 FROM information_schema.routines 
        WHERE routine_name = 'validate_transfer_request' 
        AND routine_schema = 'public'
    ) THEN
        RAISE NOTICE '✅ validate_transfer_request function EXISTS';
    ELSE
        RAISE NOTICE '❌ validate_transfer_request function MISSING';
    END IF;
END $$;

-- =============================================================================
-- CREATE TRANSFER_STOCK FUNCTION (warehouse to warehouse)
-- =============================================================================
...
-- =============================================================================
-- CREATE TRANSFER_STOCK_TO_TRUCK FUNCTION (warehouse to truck)
-- =============================================================================
...
-- =============================================================================
-- CREATE TRANSFER_STOCK_FROM_TRUCK FUNCTION (truck to warehouse)
-- =============================================================================
...
-- =============================================================================
-- CREATE VALIDATE_TRANSFER_REQUEST FUNCTION
-- =============================================================================
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '❌ transfer_stock function creation failed';
    END IF;
    ...
    ELSE
        RAISE NOTICE '❌ transfer_stock_to_truck function creation failed';
    END IF;
    ...
    ELSE
        RAISE NOTICE '❌ transfer_stock_from_truck function creation failed';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.routines WHERE routine_name = 'validate_transfer_request' AND routine_schema = 'public') THEN
        RAISE NOTICE '✅ validate_transfer_request function created successfully';
    ELSE
        RAISE NOTICE '❌ validate_transfer_request function creation failed';
    END IF;
    
    RAISE NOTICE '';
    RAISE NOTICE '=== NEXT STEPS ===';
    RAISE NOTICE '1. Test the functions with sample data';
    RAISE NOTICE '2. Verify API endpoints can call these functions';
    RAISE NOTICE '3. Update frontend to use transfer functionality';
    RAISE NOTICE '';
    RAISE NOTICE 'All transfer functions are now available!';
END $$;

COMMIT;

-- Success message
SELECT 'Transfer functions verification and creation completed successfully!' as result;