...
export const RouteStatusEnum = z.enum(['planned', 'loading', 'loaded', 'in_transit', 'delivering', 'unloading', 'completed', 'cancelled']);
export const TripStatusEnum = z.enum(['planned', 'loading', 'loaded', 'in_transit', 'delivering', 'unloading', 'completed', 'cancelled']);
